 ...
 * Creates RBAC tables
 *
 * Cloned from @vendor/yiisoft/rbac/migrations/m140506_102106_rbac_init.php
 * Changed user_id at assignment table: as foreign key to users table.
 */
class m151012_200346_user__rbac extends Migration
{
    private $table = '{{%user}}';
    ...
    public function safeUp()
    {
        ...
        $this->createTable($authManager->assignmentTable, [
            ...
            'FOREIGN KEY (user_id) REFERENCES ' . $this->table . ' (id) ON DELETE CASCADE ON UPDATE CASCADE',
        ], $tableOptions);
    }
